<section class="max-w-7xl mx-auto px-4 py-12">
    ...
    <form method="get" action="<?= url('/shop') ?>" class="grid md:grid-cols-4 gap-4 mb-8">
        ...
        <input name="max_price" type="number" placeholder="Preț maxim" value="<?= e((string)($filters['max_price'] ?? '')) ?>" class="bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2">
        <button class="bg-accent text-zinc-950 rounded-lg px-3 py-2">Filtrează</button>
    </form>
