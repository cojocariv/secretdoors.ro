<article class="break-inside-avoid mb-6 bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800">
    <img src="<?= e($project['image_url']) ?>" alt="<?= e($project['title']) ?>" loading="lazy" class="js-lightbox w-full object-cover cursor-zoom-in" tabindex="0" role="button" aria-label="Mareste imaginea">
    <div class="p-4">
